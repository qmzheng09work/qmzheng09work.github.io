...
<u>Descriptions</u>  
Applications are invited for one full-time PhD student to join Prof. Qiming Zheng’s team in the Department of Geography and Resource Management at the Chinese University of Hong Kong, starting from 2026 Fall.  

Successful candidate is expected to perform the following duties:
1.	Developing high-quality and original research in one of the following topics: Night-time Light Remote Sensing, Climate Change Mitigation, Global Environmental Changes, Urban Sustainability, or any relevant topic;
2.	Performing other duties as assigned.
...
<u>What We Offer</u>   
1.	**Up to four years of PhD scholarship (approximately. 19,000 HKD per month)**;
2.	A supportive, encouraging, equal, and collaborative working environment;
3.	Financial support for purchasing a working laptop/PC and attending international conferences;

<u>To Apply We Offer</u>   
1.  Applicants should email Prof. Qiming Zheng (qmzheng@cuhk.edu.hk) with “PhD Application” in the subject line and the following documents: (1) Cover letter; (2) CV; (3) Certificate of English Proficiency (IELTS≥6.5 or equivalent); (4) Research plan (2-pg max.)； 
2.  Review of applications will start as soon as possible and continue until **Mar 31, 2026**, or until the post is filled, whichever is earlier. For further inquiries, please contact Prof. Zheng.
...
<u>Qualifications</u>  
1.	Full-time PhD student from a Top 100 major global university (required by OAL);
2.	Be in the 2nd year of study or above when they undertake the visit (required by OAL);
3.	Proficiency in geospatial and data analysis, and computer programming (e.g., MATLAB, Python, R, C++, etc.);
4.	Excellent written and oral communication skills, demonstrated ability to work independently as well as in a collaborative team environment.

<u>To Apply We Offer</u>   
1.	Free on-campus accommodation (provided by OAL)
2.	Additional financial support, subject to academic performance (provided by Prof. Zheng)
3.	A supportive, encouraging, equal, and collaborative working environment.

<u>To Apply We Offer</u>   
Applicants should email Prof. Qiming Zheng (qmzheng@cuhk.edu.hk) with “Visiting PhD Application” in the subject line and the following documents: (1) Cover letter; (2) CV; (3) Research plan (2-pg max.).  
